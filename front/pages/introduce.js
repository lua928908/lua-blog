					...
					<Collapse accordion>
						...
						<Panel header="아인슈타인에 연봉을 후려쳤다면? " key="아인슈타인에 연봉을 후려쳤다면?">
							<p>
								...
								아인슈타인의 실력이 어느정도인지 알고있었기에 몸값이 오르는건 시간문제였고 저평가 되어있던 아인슈타인에게 고액의 연봉을 제시하며 신임을 얻었다. 아인슈타인이 통일장 이론을 정립,발전시키며
								루즈벨트 대통령에게 독일보다 먼저 원자폭탄을 개발해야 한다고 설득하기도 했다. 이처럼 회사와 직원이 신뢰를 구축하기 위해 서로 노력하는건 아주 중요한 문제라고 생각한다.
							</p>
						</Panel>
						<Panel header="야근의 요정" key="야근의 요정">
							<p>
								이직할때 여러가지의 요소를 고민하고 살피겠지만 개인적으로 야근의 유/무, 빈도를 중요시 생각한다.
								여자가 남자보다 하루동안 평균 3배 더 많이 말한다고 한다. 개인이 하루에 소모해야할 말의양을 다 쓰고나면 더이상 말하기를 거부한다.
								사람이 하루동안 소모해야할 대화의 양이 있듯이 일,공부,놀이도 하루동안 채워야하는 양이 있는것 같다. 회사에서 너무많이 일을하고 야근을 하면
								집에와서는 공부를 하는것이 현실적으로 어렵다고 본다. 야근을 많이하는건 단순히 일을 많이 하는것 뿐만아니라 
								<b>자기계발을 위해 공부하기 어려운 환경에 처하는 것이라고 생각한다.</b>
							</p>
						</Panel>
						<Panel header="젊음이 혁신을 보장하지 않는다." key="젊음이 혁신을 보장하지 않는다">
							<p>
								젊음이 혁신을 보장하지않고 나이가 노련함을 보장하지 않듯, 의외로 해보기 전까지는 잘 모른다.
							</p>
						</Panel>
